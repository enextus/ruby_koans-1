...
class AboutOpenClasses < Neo::Koan
  ...
  #  The :: references the global class of Integer.
     #  If there is also a subordinate Integer class somewhere else in the code,
     #  this prevents confusion between the two by explicitly calling the global class.
     #
